...
if( LLVM_ENABLE_OPENSSL )
  message(STATUS "OpenSSL is enabled. Looking for OpenSSL package.")
  find_package(OpenSSL)
  if (OPENSSL_FOUND)
    message(STATUS "Found OpenSSL package.")
    set(HAVE_OPENSSL 1)
  else()
    message(STATUS "Did not find OpenSSL package.")
    set(HAVE_OPENSSL 0)
  endif()
else()
  message(STATUS "OpenSSL is disabled. Using insecure builting RNG.")
  set(HAVE_OPENSSL 0)
endif()
