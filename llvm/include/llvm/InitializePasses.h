...
void initializeDiversityPassPass(PassRegistry&);
void initializeCollectStatisticsPass(PassRegistry&);
...
void initializeR2CMarkerPass(PassRegistry&);
void initializeHeapBoobyTrapPassPass(PassRegistry&);
