...
namespace llvm {
  ...
  private:
    ...
    DenseMap<StringRef, MCSymbol *> BTArrayReturnLocs;
  ...
  public:
    ...
    void addBoobyTrapReturnLoc(const StringRef ArrayName, MCSymbol *Symbol);
    MCSymbol *getBoobyTrapReturnLoc(const StringRef ArrayName);
  };
